...
update <- read_csv("https://www.careinspectorate.com/images/documents/7331/MDSF_data_30%20September%202023.csv", locale = locale(encoding = "Windows-1252"))
...
write.csv(update, "data/update_test.csv", row.names = FALSE)
