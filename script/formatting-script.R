...
update <- read_csv("https://www.careinspectorate.com/images/documents/7284/MDSF_data_31%20August%202023.csv", locale = locale(encoding = "Windows-1252"))
...
write.csv(update, "data/CIfull.csv", row.names = FALSE)
